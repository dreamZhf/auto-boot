...
public class TtlMDCAdapter implements MDCAdapter {
    ...
    final TransmittableThreadLocal<Map<String, String>> copyOnThreadLocal = new TransmittableThreadLocal<Map<String, String>>();

    private static final int WRITE_OPERATION = 1;
    private static final int MAP_COPY_OPERATION = 2;

    // keeps track of the last operation performed
    final TransmittableThreadLocal<Integer> lastOperation = new TransmittableThreadLocal<Integer>();
