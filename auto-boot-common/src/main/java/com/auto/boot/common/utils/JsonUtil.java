...
public class JsonUtil {
    ...
    public static Map<String, Object> json2Map(String json) {
        ...
        try {
            map = getInstance().readValue(json, HashMap.class);
        } catch (IOException e) {
    ...
    private static class JacksonObjectMapper extends ObjectMapper {
        ...
        public JacksonObjectMapper() {
            ...
            //序列化时，日期的统一格式
            super.setDateFormat(new SimpleDateFormat(DateTimeUtil.FORMATTER_2, Locale.CHINA));
            // 单引号
            ...
            //日期格式化
            super.registerModule(new CoreJavaTimeModule());
            super.findAndRegisterModules();
        }
